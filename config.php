...
// Código PHP al inicio de cada archivo
$horarios_alarma = [];
...
@media (min-width: 768px) {
    ...
    <main>
        ...
        <div class="card">
            ...
            <div>
                <p><span>Versión:</span  class= "c"> 1.5.2</p><br>
                <p><span>Dispositivo:</span  class= "c"> No Conectado</p><br>
                <p><span>Estado:</span> <span  class= "c">Inactivo</span></p><br>
            </div>
        </div>
    </main>
    <script>
